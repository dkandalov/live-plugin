...
### More examples
 - [intellij-emacs](https://github.com/kenfox/intellij-emacs) - live-plugin macros for making IntelliJ more friendly to emacs users (see also [blog post](http://spin.atomicobject.com/2014/08/07/intellij-emacs/))
