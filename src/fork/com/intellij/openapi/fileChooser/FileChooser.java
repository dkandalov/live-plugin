...
public class FileChooser {
  ...
  /**
   * @deprecated use {@linkplain #chooseFiles(fork.com.intellij.openapi.fileChooser.FileChooserDescriptor,
  ...
  /**
   * @deprecated use {@linkplain #chooseFile(fork.com.intellij.openapi.fileChooser.FileChooserDescriptor,
   *                                         com.intellij.openapi.project.Project,
   *                                         com.intellij.openapi.vfs.VirtualFile)} (to remove in IDEA 13)
   */
  @SuppressWarnings("UnusedDeclaration")
