...
public class FileElement {
  ...
  private ru.intellijeval.toolwindow.fileChooser.FileElement myParent;
  ...
  public void setParent(final ru.intellijeval.toolwindow.fileChooser.FileElement parent) {
    myParent = parent;
  }
  ...
  public boolean equals(Object obj) {
    if (obj instanceof ru.intellijeval.toolwindow.fileChooser.FileElement) {
      if (Comparing.equal(((ru.intellijeval.toolwindow.fileChooser.FileElement)obj).myFile, myFile)) return true;
    }
    return false;
  }
