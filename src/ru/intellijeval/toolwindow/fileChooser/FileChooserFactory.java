...
public abstract class FileChooserFactory {
  ...
  /**
   * @deprecated use {@linkplain #createFileChooser(ru.intellijeval.toolwindow.fileChooser.FileChooserDescriptor, com.intellij.openapi.project.Project, java.awt.Component)}
   ...
   */
  @NotNull
  public abstract ru.intellijeval.toolwindow.fileChooser.FileSaverDialog createSaveFileDialog(@NotNull FileSaverDescriptor descriptor, @Nullable Project project);
