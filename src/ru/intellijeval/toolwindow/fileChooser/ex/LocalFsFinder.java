...
public class LocalFsFinder implements FileLookup.Finder, FileLookup {
  ...
  public static class VfsFile implements LookupFile {
    ...
    private final ru.intellijeval.toolwindow.fileChooser.ex.LocalFsFinder myFinder;

    private String myMacro;

    public VfsFile(ru.intellijeval.toolwindow.fileChooser.ex.LocalFsFinder finder, final VirtualFile file) {
      myFinder = finder;
      myFile = file;
    }
