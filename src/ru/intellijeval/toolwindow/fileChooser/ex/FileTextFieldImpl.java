...
import ru.intellijeval.toolwindow.fileChooser.FileTextField;
...
public abstract class FileTextFieldImpl implements FileLookup, Disposable, FileTextField {
  ...
  public FileTextFieldImpl(final JTextField field, Finder finder, LookupFilter filter, Map<String, String> macroMap, final Disposable parent) {
    ...
    new LazyUiDisposable<ru.intellijeval.toolwindow.fileChooser.ex.FileTextFieldImpl>(parent, field, this) {
      protected void initialize(@NotNull Disposable parent, @NotNull ru.intellijeval.toolwindow.fileChooser.ex.FileTextFieldImpl child, @Nullable Project project) {
    ...
    if (myList == null) {
      ...
      myList.setCellRenderer(new GroupedItemsListRenderer(new ListItemDescriptor() {
        ...
        public String getCaptionAboveOf(final Object value) {
          final ru.intellijeval.toolwindow.fileChooser.ex.FileTextFieldImpl.Separator separator = getSeparatorAboveOf(value);
  ...
  public static class Vfs extends ru.intellijeval.toolwindow.fileChooser.ex.FileTextFieldImpl {
