...
public class FileChooser {
  ...
  /**
   * @deprecated use {@linkplain #chooseFiles(ru.intellijeval.toolwindow.fileChooser.FileChooserDescriptor,
  ...
  /**
   * @deprecated use {@linkplain #chooseFile(ru.intellijeval.toolwindow.fileChooser.FileChooserDescriptor,
   *                                         com.intellij.openapi.project.Project,
   *                                         com.intellij.openapi.vfs.VirtualFile)} (to remove in IDEA 13)
   */
  @SuppressWarnings("UnusedDeclaration")
