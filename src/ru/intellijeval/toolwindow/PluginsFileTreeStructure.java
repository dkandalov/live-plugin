...
public class PluginsFileTreeStructure extends AbstractTreeStructure { // TODO probably can be replaced with FileTreeStructure
  ...
  public PluginsFileTreeStructure(Project project, FileChooserDescriptor chooserDescriptor) {
    myProject = project;
